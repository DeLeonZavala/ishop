        ...
        <div class="grid grid-cols-2 gap-6">
            ...
            <div>
                ...
                <div class="flex">
                    ...
                    <a class="text-orange-500 underline hover:text-orange-700" href="">77 reseñas</a>
                </div>
                ...
                <div class="bg-white rounded-lg shadow-lg mb-6">
                    <div class="p-4 flex items-center">
                        ...
                        <div class="ml-4">
                            <p class="text-lg font-semibold text-greenLime-600">Se hacen envios a todo México</p>
                            <p>Recibelo entre el {{ Date::now()->addDay(4)->locale('es')->format('l j F') }} y el {{ Date::now()->addDay(7)->locale('es')->format('l j F') }}</p>
                        </div>
                    </div>
                </div>
